...
class DateTime extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('DateTime', package: const $pb.PackageName('google.type'), createEmptyInstance: create)
    ..oo(0, [8, 9])
    ...
    ..aOM<$1.Duration>(8, 'utcOffset', subBuilder: $1.Duration.create)
...
class TimeZone extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('TimeZone', package: const $pb.PackageName('google.type'), createEmptyInstance: create)
    ..aOS(1, 'id')
    ..aOS(2, 'version')
    ..hasRequiredFields = false
  ;
