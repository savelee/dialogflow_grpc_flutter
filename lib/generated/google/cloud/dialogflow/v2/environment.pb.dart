...
class Environment extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Environment', package: const $pb.PackageName('google.cloud.dialogflow.v2'), createEmptyInstance: create)
    ..aOS(1, 'name')
    ..aOS(2, 'description')
    ..aOS(3, 'agentVersion')
    ...
    ..aOM<$22.Timestamp>(5, 'updateTime', subBuilder: $22.Timestamp.create)
  ...
  @$pb.TagNumber(5)
  $22.Timestamp get updateTime => $_getN(4);
  @$pb.TagNumber(5)
  set updateTime($22.Timestamp v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasUpdateTime() => $_has(4);
  @$pb.TagNumber(5)
  void clearUpdateTime() => clearField(5);
  @$pb.TagNumber(5)
  $22.Timestamp ensureUpdateTime() => $_ensure(4);
}

class ListEnvironmentsRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ListEnvironmentsRequest', package: const $pb.PackageName('google.cloud.dialogflow.v2'), createEmptyInstance: create)
    ..aOS(1, 'parent')
...
class ListEnvironmentsResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ListEnvironmentsResponse', package: const $pb.PackageName('google.cloud.dialogflow.v2'), createEmptyInstance: create)
