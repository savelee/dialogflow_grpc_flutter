...
class WebhookRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('WebhookRequest', package: const $pb.PackageName('google.cloud.dialogflow.v2'), createEmptyInstance: create)
    ..aOS(1, 'responseId')
    ..aOM<$8.QueryResult>(2, 'queryResult', subBuilder: $8.QueryResult.create)
...
class WebhookResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('WebhookResponse', package: const $pb.PackageName('google.cloud.dialogflow.v2'), createEmptyInstance: create)
    ..aOS(1, 'fulfillmentText')
    ..pc<$5.Intent_Message>(2, 'fulfillmentMessages', $pb.PbFieldType.PM, subBuilder: $5.Intent_Message.create)
    ..aOS(3, 'source')
    ..aOM<$18.Struct>(4, 'payload', subBuilder: $18.Struct.create)
    ..pc<$4.Context>(5, 'outputContexts', $pb.PbFieldType.PM, subBuilder: $4.Context.create)
    ..aOM<$8.EventInput>(6, 'followupEventInput', subBuilder: $8.EventInput.create)
    ..pc<$7.SessionEntityType>(10, 'sessionEntityTypes', $pb.PbFieldType.PM, subBuilder: $7.SessionEntityType.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(4)
  set payload($18.Struct v) { setField(4, v); }
  @$pb.TagNumber(4)
...
class OriginalDetectIntentRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('OriginalDetectIntentRequest', package: const $pb.PackageName('google.cloud.dialogflow.v2'), createEmptyInstance: create)
    ..aOS(1, 'source')
    ..aOS(2, 'version')
    ..aOM<$18.Struct>(3, 'payload', subBuilder: $18.Struct.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(3)
  set payload($18.Struct v) { setField(3, v); }
  @$pb.TagNumber(3)
