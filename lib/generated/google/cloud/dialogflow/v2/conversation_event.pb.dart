...
class ConversationEvent extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ConversationEvent', package: const $pb.PackageName('google.cloud.dialogflow.v2'), createEmptyInstance: create)
    ..oo(0, [4])
    ..aOS(1, 'conversation')
    ...
    ..aOM<$20.Status>(3, 'errorStatus', subBuilder: $20.Status.create)
    ..aOM<$9.Message>(4, 'newMessagePayload', subBuilder: $9.Message.create)
  ...
  @$pb.TagNumber(3)
  set errorStatus($20.Status v) { setField(3, v); }
  @$pb.TagNumber(3)
