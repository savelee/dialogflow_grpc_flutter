...
class SpeechContext extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('SpeechContext', package: const $pb.PackageName('google.cloud.dialogflow.v2'), createEmptyInstance: create)
    ..pPS(1, 'phrases')
...
class SpeechWordInfo extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('SpeechWordInfo', package: const $pb.PackageName('google.cloud.dialogflow.v2'), createEmptyInstance: create)
    ..aOM<$17.Duration>(1, 'startOffset', subBuilder: $17.Duration.create)
    ..aOM<$17.Duration>(2, 'endOffset', subBuilder: $17.Duration.create)
    ..aOS(3, 'word')
  ...
  @$pb.TagNumber(1)
  $17.Duration get startOffset => $_getN(0);
  @$pb.TagNumber(1)
  set startOffset($17.Duration v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasStartOffset() => $_has(0);
  @$pb.TagNumber(1)
  void clearStartOffset() => clearField(1);
  @$pb.TagNumber(1)
  $17.Duration ensureStartOffset() => $_ensure(0);

  @$pb.TagNumber(2)
  $17.Duration get endOffset => $_getN(1);
  @$pb.TagNumber(2)
  set endOffset($17.Duration v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasEndOffset() => $_has(1);
  @$pb.TagNumber(2)
  void clearEndOffset() => clearField(2);
  @$pb.TagNumber(2)
  $17.Duration ensureEndOffset() => $_ensure(1);
...
class InputAudioConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('InputAudioConfig', package: const $pb.PackageName('google.cloud.dialogflow.v2'), createEmptyInstance: create)
    ...
    ..pc<SpeechContext>(11, 'speechContexts', $pb.PbFieldType.PM, subBuilder: SpeechContext.create)
    ..aOB(13, 'enableWordInfo')
    ..aOB(14, 'disableNoSpeechRecognizedEvent')
    ..hasRequiredFields = false
  ;
...
class VoiceSelectionParams extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('VoiceSelectionParams', package: const $pb.PackageName('google.cloud.dialogflow.v2'), createEmptyInstance: create)
    ..aOS(1, 'name')
...
class SynthesizeSpeechConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('SynthesizeSpeechConfig', package: const $pb.PackageName('google.cloud.dialogflow.v2'), createEmptyInstance: create)
...
class OutputAudioConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('OutputAudioConfig', package: const $pb.PackageName('google.cloud.dialogflow.v2'), createEmptyInstance: create)
...
class TelephonyDtmfEvents extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('TelephonyDtmfEvents', package: const $pb.PackageName('google.cloud.dialogflow.v2'), createEmptyInstance: create)
    ..pc<TelephonyDtmf>(1, 'dtmfEvents', $pb.PbFieldType.PE, valueOf: TelephonyDtmf.valueOf, enumValues: TelephonyDtmf.values)
    ..hasRequiredFields = false
  ;

  TelephonyDtmfEvents._() : super();
  factory TelephonyDtmfEvents() => create();
  ...
  TelephonyDtmfEvents copyWith(void Function(TelephonyDtmfEvents) updates) => super.copyWith((message) => updates(message as TelephonyDtmfEvents));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class SpeechToTextConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('SpeechToTextConfig', package: const $pb.PackageName('google.cloud.dialogflow.v2'), createEmptyInstance: create)
    ..e<SpeechModelVariant>(1, 'speechModelVariant', $pb.PbFieldType.OE, defaultOrMaker: SpeechModelVariant.SPEECH_MODEL_VARIANT_UNSPECIFIED, valueOf: SpeechModelVariant.valueOf, enumValues: SpeechModelVariant.values)
    ..hasRequiredFields = false
  ;

  SpeechToTextConfig._() : super();
  factory SpeechToTextConfig() => create();
  ...
  SpeechToTextConfig copyWith(void Function(SpeechToTextConfig) updates) => super.copyWith((message) => updates(message as SpeechToTextConfig));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
