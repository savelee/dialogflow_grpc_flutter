...
class ValidationError extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ValidationError', package: const $pb.PackageName('google.cloud.dialogflow.v2'), createEmptyInstance: create)
...
class ValidationResult extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ValidationResult', package: const $pb.PackageName('google.cloud.dialogflow.v2'), createEmptyInstance: create)
