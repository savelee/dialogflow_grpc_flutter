...
class AnswerRecord extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('AnswerRecord', package: const $pb.PackageName('google.cloud.dialogflow.v2'), createEmptyInstance: create)
    ..oo(0, [4])
    ..aOS(1, 'name')
    ..aOM<AnswerFeedback>(2, 'answerFeedback', subBuilder: AnswerFeedback.create)
...
class ListAnswerRecordsRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ListAnswerRecordsRequest', package: const $pb.PackageName('google.cloud.dialogflow.v2'), createEmptyInstance: create)
    ..aOS(1, 'parent')
    ..aOS(2, 'filter')
...
class ListAnswerRecordsResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ListAnswerRecordsResponse', package: const $pb.PackageName('google.cloud.dialogflow.v2'), createEmptyInstance: create)
...
class UpdateAnswerRecordRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('UpdateAnswerRecordRequest', package: const $pb.PackageName('google.cloud.dialogflow.v2'), createEmptyInstance: create)
...
class AnswerFeedback extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('AnswerFeedback', package: const $pb.PackageName('google.cloud.dialogflow.v2'), createEmptyInstance: create)
    ..oo(0, [2])
    ...
    ..aOB(3, 'clicked')
    ..aOB(4, 'displayed')
    ..aOM<$22.Timestamp>(5, 'clickTime', subBuilder: $22.Timestamp.create)
    ..aOM<$22.Timestamp>(6, 'displayTime', subBuilder: $22.Timestamp.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(5)
  set clickTime($22.Timestamp v) { setField(5, v); }
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(6)
  set displayTime($22.Timestamp v) { setField(6, v); }
  @$pb.TagNumber(6)
...
class AgentAssistantFeedback extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('AgentAssistantFeedback', package: const $pb.PackageName('google.cloud.dialogflow.v2'), createEmptyInstance: create)
...
class AgentAssistantRecord extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('AgentAssistantRecord', package: const $pb.PackageName('google.cloud.dialogflow.v2'), createEmptyInstance: create)
    ..oo(0, [5, 6])
    ..aOM<$9.ArticleAnswer>(5, 'articleSuggestionAnswer', subBuilder: $9.ArticleAnswer.create)
    ..aOM<$9.FaqAnswer>(6, 'faqAnswer', subBuilder: $9.FaqAnswer.create)
    ..hasRequiredFields = false
  ;
