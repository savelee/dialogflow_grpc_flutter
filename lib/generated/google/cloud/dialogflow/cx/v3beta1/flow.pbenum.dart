...
class NluSettings_ModelType extends $pb.ProtobufEnum {
  static const NluSettings_ModelType MODEL_TYPE_UNSPECIFIED = NluSettings_ModelType._(0, 'MODEL_TYPE_UNSPECIFIED');
  static const NluSettings_ModelType MODEL_TYPE_STANDARD = NluSettings_ModelType._(1, 'MODEL_TYPE_STANDARD');
  static const NluSettings_ModelType MODEL_TYPE_ADVANCED = NluSettings_ModelType._(3, 'MODEL_TYPE_ADVANCED');
...
class NluSettings_ModelTrainingMode extends $pb.ProtobufEnum {
  static const NluSettings_ModelTrainingMode MODEL_TRAINING_MODE_UNSPECIFIED = NluSettings_ModelTrainingMode._(0, 'MODEL_TRAINING_MODE_UNSPECIFIED');
  static const NluSettings_ModelTrainingMode MODEL_TRAINING_MODE_AUTOMATIC = NluSettings_ModelTrainingMode._(1, 'MODEL_TRAINING_MODE_AUTOMATIC');
  static const NluSettings_ModelTrainingMode MODEL_TRAINING_MODE_MANUAL = NluSettings_ModelTrainingMode._(2, 'MODEL_TRAINING_MODE_MANUAL');
