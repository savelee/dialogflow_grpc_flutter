...
class ResponseMessage_Text extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ResponseMessage.Text', package: const $pb.PackageName('google.cloud.dialogflow.cx.v3'), createEmptyInstance: create)
    ..pPS(1, 'text')
...
class ResponseMessage_LiveAgentHandoff extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ResponseMessage.LiveAgentHandoff', package: const $pb.PackageName('google.cloud.dialogflow.cx.v3'), createEmptyInstance: create)
...
class ResponseMessage_ConversationSuccess extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ResponseMessage.ConversationSuccess', package: const $pb.PackageName('google.cloud.dialogflow.cx.v3'), createEmptyInstance: create)
    ..aOM<$16.Struct>(1, 'metadata', subBuilder: $16.Struct.create)
    ..hasRequiredFields = false
  ;
...
class ResponseMessage_OutputAudioText extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ResponseMessage.OutputAudioText', package: const $pb.PackageName('google.cloud.dialogflow.cx.v3'), createEmptyInstance: create)
    ..oo(0, [1, 2])
    ..aOS(1, 'text')
    ..aOS(2, 'ssml')
...
class ResponseMessage_EndInteraction extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ResponseMessage.EndInteraction', package: const $pb.PackageName('google.cloud.dialogflow.cx.v3'), createEmptyInstance: create)
    ..hasRequiredFields = false
  ;
...
class ResponseMessage_PlayAudio extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ResponseMessage.PlayAudio', package: const $pb.PackageName('google.cloud.dialogflow.cx.v3'), createEmptyInstance: create)
    ..aOS(1, 'audioUri')
    ..aOB(2, 'allowPlaybackInterruption')
    ..hasRequiredFields = false
  ;
...
class ResponseMessage_MixedAudio_Segment extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ResponseMessage.MixedAudio.Segment', package: const $pb.PackageName('google.cloud.dialogflow.cx.v3'), createEmptyInstance: create)
    ..oo(0, [1, 2])
...
class ResponseMessage_MixedAudio extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ResponseMessage.MixedAudio', package: const $pb.PackageName('google.cloud.dialogflow.cx.v3'), createEmptyInstance: create)
...
class ResponseMessage extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ResponseMessage', package: const $pb.PackageName('google.cloud.dialogflow.cx.v3'), createEmptyInstance: create)
