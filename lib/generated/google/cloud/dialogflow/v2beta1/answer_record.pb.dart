...
class AnswerRecord extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('AnswerRecord', package: const $pb.PackageName('google.cloud.dialogflow.v2beta1'), createEmptyInstance: create)
    ..oo(0, [4])
    ..aOS(1, 'name')
    ..aOM<AnswerFeedback>(3, 'answerFeedback', subBuilder: AnswerFeedback.create)
    ..aOM<AgentAssistantRecord>(4, 'agentAssistantRecord', subBuilder: AgentAssistantRecord.create)
    ..hasRequiredFields = false
  ;

  AnswerRecord._() : super();
  factory AnswerRecord() => create();
  ...
  AnswerRecord copyWith(void Function(AnswerRecord) updates) => super.copyWith((message) => updates(message as AnswerRecord));
...
class AgentAssistantRecord extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('AgentAssistantRecord', package: const $pb.PackageName('google.cloud.dialogflow.v2beta1'), createEmptyInstance: create)
    ..oo(0, [5, 6])
    ..aOM<$10.ArticleAnswer>(5, 'articleSuggestionAnswer', subBuilder: $10.ArticleAnswer.create)
    ..aOM<$10.FaqAnswer>(6, 'faqAnswer', subBuilder: $10.FaqAnswer.create)
    ..hasRequiredFields = false
  ;

  AgentAssistantRecord._() : super();
  factory AgentAssistantRecord() => create();
  ...
  AgentAssistantRecord copyWith(void Function(AgentAssistantRecord) updates) => super.copyWith((message) => updates(message as AgentAssistantRecord));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(5)
  set articleSuggestionAnswer($10.ArticleAnswer v) { setField(5, v); }
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(6)
  set faqAnswer($10.FaqAnswer v) { setField(6, v); }
  @$pb.TagNumber(6)
...
class AnswerFeedback extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('AnswerFeedback', package: const $pb.PackageName('google.cloud.dialogflow.v2beta1'), createEmptyInstance: create)
    ..oo(0, [2])
    ..e<AnswerFeedback_CorrectnessLevel>(1, 'correctnessLevel', $pb.PbFieldType.OE, defaultOrMaker: AnswerFeedback_CorrectnessLevel.CORRECTNESS_LEVEL_UNSPECIFIED, valueOf: AnswerFeedback_CorrectnessLevel.valueOf, enumValues: AnswerFeedback_CorrectnessLevel.values)
    ..aOM<AgentAssistantFeedback>(2, 'agentAssistantDetailFeedback', subBuilder: AgentAssistantFeedback.create)
    ..aOB(3, 'clicked')
    ..aOB(4, 'displayed')
    ..aOM<$17.Timestamp>(5, 'clickTime', subBuilder: $17.Timestamp.create)
    ..aOM<$17.Timestamp>(6, 'displayTime', subBuilder: $17.Timestamp.create)
    ..hasRequiredFields = false
  ;

  AnswerFeedback._() : super();
  factory AnswerFeedback() => create();
  ...
  AnswerFeedback copyWith(void Function(AnswerFeedback) updates) => super.copyWith((message) => updates(message as AnswerFeedback));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(5)
  set clickTime($17.Timestamp v) { setField(5, v); }
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(6)
  set displayTime($17.Timestamp v) { setField(6, v); }
  @$pb.TagNumber(6)
...
class AgentAssistantFeedback_SummarizationFeedback extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('AgentAssistantFeedback.SummarizationFeedback', package: const $pb.PackageName('google.cloud.dialogflow.v2beta1'), createEmptyInstance: create)
    ..aOM<$17.Timestamp>(1, 'startTimestamp', subBuilder: $17.Timestamp.create)
    ..aOM<$17.Timestamp>(2, 'submitTimestamp', subBuilder: $17.Timestamp.create)
    ..aOS(3, 'summaryText')
    ..hasRequiredFields = false
  ;

  AgentAssistantFeedback_SummarizationFeedback._() : super();
  factory AgentAssistantFeedback_SummarizationFeedback() => create();
  ...
  AgentAssistantFeedback_SummarizationFeedback copyWith(void Function(AgentAssistantFeedback_SummarizationFeedback) updates) => super.copyWith((message) => updates(message as AgentAssistantFeedback_SummarizationFeedback));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(1)
  set startTimestamp($17.Timestamp v) { setField(1, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  set submitTimestamp($17.Timestamp v) { setField(2, v); }
  @$pb.TagNumber(2)
...
class AgentAssistantFeedback extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('AgentAssistantFeedback', package: const $pb.PackageName('google.cloud.dialogflow.v2beta1'), createEmptyInstance: create)
    ..e<AgentAssistantFeedback_AnswerRelevance>(1, 'answerRelevance', $pb.PbFieldType.OE, defaultOrMaker: AgentAssistantFeedback_AnswerRelevance.ANSWER_RELEVANCE_UNSPECIFIED, valueOf: AgentAssistantFeedback_AnswerRelevance.valueOf, enumValues: AgentAssistantFeedback_AnswerRelevance.values)
    ..e<AgentAssistantFeedback_DocumentCorrectness>(2, 'documentCorrectness', $pb.PbFieldType.OE, defaultOrMaker: AgentAssistantFeedback_DocumentCorrectness.DOCUMENT_CORRECTNESS_UNSPECIFIED, valueOf: AgentAssistantFeedback_DocumentCorrectness.valueOf, enumValues: AgentAssistantFeedback_DocumentCorrectness.values)
    ..e<AgentAssistantFeedback_DocumentEfficiency>(3, 'documentEfficiency', $pb.PbFieldType.OE, defaultOrMaker: AgentAssistantFeedback_DocumentEfficiency.DOCUMENT_EFFICIENCY_UNSPECIFIED, valueOf: AgentAssistantFeedback_DocumentEfficiency.valueOf, enumValues: AgentAssistantFeedback_DocumentEfficiency.values)
    ..aOM<AgentAssistantFeedback_SummarizationFeedback>(4, 'summarizationFeedback', subBuilder: AgentAssistantFeedback_SummarizationFeedback.create)
    ..hasRequiredFields = false
  ;

  AgentAssistantFeedback._() : super();
  factory AgentAssistantFeedback() => create();
  ...
  AgentAssistantFeedback copyWith(void Function(AgentAssistantFeedback) updates) => super.copyWith((message) => updates(message as AgentAssistantFeedback));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class GetAnswerRecordRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('GetAnswerRecordRequest', package: const $pb.PackageName('google.cloud.dialogflow.v2beta1'), createEmptyInstance: create)
    ..aOS(1, 'name')
    ..hasRequiredFields = false
  ;

  GetAnswerRecordRequest._() : super();
  factory GetAnswerRecordRequest() => create();
  ...
  GetAnswerRecordRequest copyWith(void Function(GetAnswerRecordRequest) updates) => super.copyWith((message) => updates(message as GetAnswerRecordRequest));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ListAnswerRecordsRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ListAnswerRecordsRequest', package: const $pb.PackageName('google.cloud.dialogflow.v2beta1'), createEmptyInstance: create)
    ..aOS(1, 'parent')
  ...
  factory ListAnswerRecordsRequest() => create();
  ...
  ListAnswerRecordsRequest copyWith(void Function(ListAnswerRecordsRequest) updates) => super.copyWith((message) => updates(message as ListAnswerRecordsRequest));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ListAnswerRecordsResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ListAnswerRecordsResponse', package: const $pb.PackageName('google.cloud.dialogflow.v2beta1'), createEmptyInstance: create)
    ..pc<AnswerRecord>(1, 'answerRecords', $pb.PbFieldType.PM, subBuilder: AnswerRecord.create)
    ..aOS(2, 'nextPageToken')
    ..hasRequiredFields = false
  ;

  ListAnswerRecordsResponse._() : super();
  factory ListAnswerRecordsResponse() => create();
  ...
  ListAnswerRecordsResponse copyWith(void Function(ListAnswerRecordsResponse) updates) => super.copyWith((message) => updates(message as ListAnswerRecordsResponse));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class UpdateAnswerRecordRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('UpdateAnswerRecordRequest', package: const $pb.PackageName('google.cloud.dialogflow.v2beta1'), createEmptyInstance: create)
    ..aOM<AnswerRecord>(1, 'answerRecord', subBuilder: AnswerRecord.create)
    ..aOM<$18.FieldMask>(2, 'updateMask', subBuilder: $18.FieldMask.create)
    ..hasRequiredFields = false
  ;

  UpdateAnswerRecordRequest._() : super();
  factory UpdateAnswerRecordRequest() => create();
  ...
  UpdateAnswerRecordRequest copyWith(void Function(UpdateAnswerRecordRequest) updates) => super.copyWith((message) => updates(message as UpdateAnswerRecordRequest));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
