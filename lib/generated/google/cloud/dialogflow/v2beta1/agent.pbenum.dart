...
class Agent_MatchMode extends $pb.ProtobufEnum {
  static const Agent_MatchMode MATCH_MODE_UNSPECIFIED = Agent_MatchMode._(0, 'MATCH_MODE_UNSPECIFIED');
  static const Agent_MatchMode MATCH_MODE_HYBRID = Agent_MatchMode._(1, 'MATCH_MODE_HYBRID');
  static const Agent_MatchMode MATCH_MODE_ML_ONLY = Agent_MatchMode._(2, 'MATCH_MODE_ML_ONLY');
...
class Agent_ApiVersion extends $pb.ProtobufEnum {
  static const Agent_ApiVersion API_VERSION_UNSPECIFIED = Agent_ApiVersion._(0, 'API_VERSION_UNSPECIFIED');
  static const Agent_ApiVersion API_VERSION_V1 = Agent_ApiVersion._(1, 'API_VERSION_V1');
  static const Agent_ApiVersion API_VERSION_V2 = Agent_ApiVersion._(2, 'API_VERSION_V2');
  static const Agent_ApiVersion API_VERSION_V2_BETA_1 = Agent_ApiVersion._(3, 'API_VERSION_V2_BETA_1');
...
class Agent_Tier extends $pb.ProtobufEnum {
  static const Agent_Tier TIER_UNSPECIFIED = Agent_Tier._(0, 'TIER_UNSPECIFIED');
  ...
  static const Agent_Tier TIER_ENTERPRISE_PLUS = Agent_Tier._(3, 'TIER_ENTERPRISE_PLUS');
