...
class Intent_Message_Platform extends $pb.ProtobufEnum {
  ...
  static const Intent_Message_Platform TELEPHONY = Intent_Message_Platform._(10, 'TELEPHONY');
...
class Intent_Message_RbmCarouselCard_CardWidth extends $pb.ProtobufEnum {
  static const Intent_Message_RbmCarouselCard_CardWidth CARD_WIDTH_UNSPECIFIED = Intent_Message_RbmCarouselCard_CardWidth._(0, 'CARD_WIDTH_UNSPECIFIED');
  static const Intent_Message_RbmCarouselCard_CardWidth SMALL = Intent_Message_RbmCarouselCard_CardWidth._(1, 'SMALL');
  static const Intent_Message_RbmCarouselCard_CardWidth MEDIUM = Intent_Message_RbmCarouselCard_CardWidth._(2, 'MEDIUM');
...
class Intent_Message_RbmStandaloneCard_CardOrientation extends $pb.ProtobufEnum {
  static const Intent_Message_RbmStandaloneCard_CardOrientation CARD_ORIENTATION_UNSPECIFIED = Intent_Message_RbmStandaloneCard_CardOrientation._(0, 'CARD_ORIENTATION_UNSPECIFIED');
  static const Intent_Message_RbmStandaloneCard_CardOrientation HORIZONTAL = Intent_Message_RbmStandaloneCard_CardOrientation._(1, 'HORIZONTAL');
  static const Intent_Message_RbmStandaloneCard_CardOrientation VERTICAL = Intent_Message_RbmStandaloneCard_CardOrientation._(2, 'VERTICAL');
...
class Intent_Message_RbmStandaloneCard_ThumbnailImageAlignment extends $pb.ProtobufEnum {
  static const Intent_Message_RbmStandaloneCard_ThumbnailImageAlignment THUMBNAIL_IMAGE_ALIGNMENT_UNSPECIFIED = Intent_Message_RbmStandaloneCard_ThumbnailImageAlignment._(0, 'THUMBNAIL_IMAGE_ALIGNMENT_UNSPECIFIED');
  static const Intent_Message_RbmStandaloneCard_ThumbnailImageAlignment LEFT = Intent_Message_RbmStandaloneCard_ThumbnailImageAlignment._(1, 'LEFT');
  static const Intent_Message_RbmStandaloneCard_ThumbnailImageAlignment RIGHT = Intent_Message_RbmStandaloneCard_ThumbnailImageAlignment._(2, 'RIGHT');
...
class Intent_Message_RbmCardContent_RbmMedia_Height extends $pb.ProtobufEnum {
  static const Intent_Message_RbmCardContent_RbmMedia_Height HEIGHT_UNSPECIFIED = Intent_Message_RbmCardContent_RbmMedia_Height._(0, 'HEIGHT_UNSPECIFIED');
  static const Intent_Message_RbmCardContent_RbmMedia_Height SHORT = Intent_Message_RbmCardContent_RbmMedia_Height._(1, 'SHORT');
  static const Intent_Message_RbmCardContent_RbmMedia_Height MEDIUM = Intent_Message_RbmCardContent_RbmMedia_Height._(2, 'MEDIUM');
  static const Intent_Message_RbmCardContent_RbmMedia_Height TALL = Intent_Message_RbmCardContent_RbmMedia_Height._(3, 'TALL');
...
class Intent_Message_MediaContent_ResponseMediaType extends $pb.ProtobufEnum {
  static const Intent_Message_MediaContent_ResponseMediaType RESPONSE_MEDIA_TYPE_UNSPECIFIED = Intent_Message_MediaContent_ResponseMediaType._(0, 'RESPONSE_MEDIA_TYPE_UNSPECIFIED');
  static const Intent_Message_MediaContent_ResponseMediaType AUDIO = Intent_Message_MediaContent_ResponseMediaType._(1, 'AUDIO');
...
class Intent_Message_BrowseCarouselCard_ImageDisplayOptions extends $pb.ProtobufEnum {
  static const Intent_Message_BrowseCarouselCard_ImageDisplayOptions IMAGE_DISPLAY_OPTIONS_UNSPECIFIED = Intent_Message_BrowseCarouselCard_ImageDisplayOptions._(0, 'IMAGE_DISPLAY_OPTIONS_UNSPECIFIED');
  static const Intent_Message_BrowseCarouselCard_ImageDisplayOptions GRAY = Intent_Message_BrowseCarouselCard_ImageDisplayOptions._(1, 'GRAY');
  static const Intent_Message_BrowseCarouselCard_ImageDisplayOptions WHITE = Intent_Message_BrowseCarouselCard_ImageDisplayOptions._(2, 'WHITE');
  static const Intent_Message_BrowseCarouselCard_ImageDisplayOptions CROPPED = Intent_Message_BrowseCarouselCard_ImageDisplayOptions._(3, 'CROPPED');
  static const Intent_Message_BrowseCarouselCard_ImageDisplayOptions BLURRED_BACKGROUND = Intent_Message_BrowseCarouselCard_ImageDisplayOptions._(4, 'BLURRED_BACKGROUND');
...
class Intent_Message_BrowseCarouselCard_BrowseCarouselCardItem_OpenUrlAction_UrlTypeHint extends $pb.ProtobufEnum {
  static const Intent_Message_BrowseCarouselCard_BrowseCarouselCardItem_OpenUrlAction_UrlTypeHint URL_TYPE_HINT_UNSPECIFIED = Intent_Message_BrowseCarouselCard_BrowseCarouselCardItem_OpenUrlAction_UrlTypeHint._(0, 'URL_TYPE_HINT_UNSPECIFIED');
  static const Intent_Message_BrowseCarouselCard_BrowseCarouselCardItem_OpenUrlAction_UrlTypeHint AMP_ACTION = Intent_Message_BrowseCarouselCard_BrowseCarouselCardItem_OpenUrlAction_UrlTypeHint._(1, 'AMP_ACTION');
  static const Intent_Message_BrowseCarouselCard_BrowseCarouselCardItem_OpenUrlAction_UrlTypeHint AMP_CONTENT = Intent_Message_BrowseCarouselCard_BrowseCarouselCardItem_OpenUrlAction_UrlTypeHint._(2, 'AMP_CONTENT');
...
class Intent_Message_ColumnProperties_HorizontalAlignment extends $pb.ProtobufEnum {
  static const Intent_Message_ColumnProperties_HorizontalAlignment HORIZONTAL_ALIGNMENT_UNSPECIFIED = Intent_Message_ColumnProperties_HorizontalAlignment._(0, 'HORIZONTAL_ALIGNMENT_UNSPECIFIED');
  static const Intent_Message_ColumnProperties_HorizontalAlignment LEADING = Intent_Message_ColumnProperties_HorizontalAlignment._(1, 'LEADING');
  static const Intent_Message_ColumnProperties_HorizontalAlignment CENTER = Intent_Message_ColumnProperties_HorizontalAlignment._(2, 'CENTER');
  static const Intent_Message_ColumnProperties_HorizontalAlignment TRAILING = Intent_Message_ColumnProperties_HorizontalAlignment._(3, 'TRAILING');
