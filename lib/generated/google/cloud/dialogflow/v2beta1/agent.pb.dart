...
class Agent extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Agent', package: const $pb.PackageName('google.cloud.dialogflow.v2beta1'), createEmptyInstance: create)
    ..aOS(1, 'parent')
    ..aOS(2, 'displayName')
    ...
    ..aOS(7, 'avatarUri')
    ..aOB(8, 'enableLogging')
    ..e<Agent_MatchMode>(9, 'matchMode', $pb.PbFieldType.OE, defaultOrMaker: Agent_MatchMode.MATCH_MODE_UNSPECIFIED, valueOf: Agent_MatchMode.valueOf, enumValues: Agent_MatchMode.values)
    ..a<$core.double>(10, 'classificationThreshold', $pb.PbFieldType.OF)
    ..e<Agent_ApiVersion>(14, 'apiVersion', $pb.PbFieldType.OE, defaultOrMaker: Agent_ApiVersion.API_VERSION_UNSPECIFIED, valueOf: Agent_ApiVersion.valueOf, enumValues: Agent_ApiVersion.values)
    ..e<Agent_Tier>(15, 'tier', $pb.PbFieldType.OE, defaultOrMaker: Agent_Tier.TIER_UNSPECIFIED, valueOf: Agent_Tier.valueOf, enumValues: Agent_Tier.values)
...
class GetAgentRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('GetAgentRequest', package: const $pb.PackageName('google.cloud.dialogflow.v2beta1'), createEmptyInstance: create)
    ..aOS(1, 'parent')
    ..hasRequiredFields = false
  ;
...
class SetAgentRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('SetAgentRequest', package: const $pb.PackageName('google.cloud.dialogflow.v2beta1'), createEmptyInstance: create)
  ...
  SetAgentRequest copyWith(void Function(SetAgentRequest) updates) => super.copyWith((message) => updates(message as SetAgentRequest));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class DeleteAgentRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('DeleteAgentRequest', package: const $pb.PackageName('google.cloud.dialogflow.v2beta1'), createEmptyInstance: create)
    ..aOS(1, 'parent')
    ..hasRequiredFields = false
  ;
...
class SubAgent extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('SubAgent', package: const $pb.PackageName('google.cloud.dialogflow.v2beta1'), createEmptyInstance: create)
    ..aOS(1, 'project')
    ..aOS(2, 'environment')
    ..hasRequiredFields = false
  ;
  ...
  SubAgent copyWith(void Function(SubAgent) updates) => super.copyWith((message) => updates(message as SubAgent));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class SearchAgentsRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('SearchAgentsRequest', package: const $pb.PackageName('google.cloud.dialogflow.v2beta1'), createEmptyInstance: create)
    ..aOS(1, 'parent')
...
class SearchAgentsResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('SearchAgentsResponse', package: const $pb.PackageName('google.cloud.dialogflow.v2beta1'), createEmptyInstance: create)
...
class TrainAgentRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('TrainAgentRequest', package: const $pb.PackageName('google.cloud.dialogflow.v2beta1'), createEmptyInstance: create)
    ..aOS(1, 'parent')
    ..hasRequiredFields = false
  ;
...
class ExportAgentRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ExportAgentRequest', package: const $pb.PackageName('google.cloud.dialogflow.v2beta1'), createEmptyInstance: create)
    ..aOS(1, 'parent')
    ..aOS(2, 'agentUri')
    ..hasRequiredFields = false
  ;
...
class ExportAgentResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ExportAgentResponse', package: const $pb.PackageName('google.cloud.dialogflow.v2beta1'), createEmptyInstance: create)
    ..oo(0, [1, 2])
    ..aOS(1, 'agentUri')
...
class ImportAgentRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ImportAgentRequest', package: const $pb.PackageName('google.cloud.dialogflow.v2beta1'), createEmptyInstance: create)
    ..oo(0, [2, 3])
    ..aOS(1, 'parent')
    ..aOS(2, 'agentUri')
...
class RestoreAgentRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('RestoreAgentRequest', package: const $pb.PackageName('google.cloud.dialogflow.v2beta1'), createEmptyInstance: create)
    ..oo(0, [2, 3])
    ..aOS(1, 'parent')
    ..aOS(2, 'agentUri')
    ..a<$core.List<$core.int>>(3, 'agentContent', $pb.PbFieldType.OY)
...
class GetValidationResultRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('GetValidationResultRequest', package: const $pb.PackageName('google.cloud.dialogflow.v2beta1'), createEmptyInstance: create)
    ..aOS(1, 'parent')
    ..aOS(3, 'languageCode')
    ..hasRequiredFields = false
  ;
  ...
  GetValidationResultRequest copyWith(void Function(GetValidationResultRequest) updates) => super.copyWith((message) => updates(message as GetValidationResultRequest));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
