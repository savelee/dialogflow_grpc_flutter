...
class DetectIntentRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('DetectIntentRequest', package: const $pb.PackageName('google.cloud.dialogflow.v2beta1'), createEmptyInstance: create)
    ..aOS(1, 'session')
    ...
    ..aOM<$20.OutputAudioConfig>(4, 'outputAudioConfig', subBuilder: $20.OutputAudioConfig.create)
    ..a<$core.List<$core.int>>(5, 'inputAudio', $pb.PbFieldType.OY)
    ..aOM<$18.FieldMask>(7, 'outputAudioConfigMask', subBuilder: $18.FieldMask.create)
  ...
  @$pb.TagNumber(4)
  set outputAudioConfig($20.OutputAudioConfig v) { setField(4, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(7)
  set outputAudioConfigMask($18.FieldMask v) { setField(7, v); }
  @$pb.TagNumber(7)
...
class DetectIntentResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('DetectIntentResponse', package: const $pb.PackageName('google.cloud.dialogflow.v2beta1'), createEmptyInstance: create)
    ..aOS(1, 'responseId')
    ..aOM<QueryResult>(2, 'queryResult', subBuilder: QueryResult.create)
    ..aOM<$21.Status>(3, 'webhookStatus', subBuilder: $21.Status.create)
    ..a<$core.List<$core.int>>(4, 'outputAudio', $pb.PbFieldType.OY)
    ..pc<QueryResult>(5, 'alternativeQueryResults', $pb.PbFieldType.PM, subBuilder: QueryResult.create)
    ..aOM<$20.OutputAudioConfig>(6, 'outputAudioConfig', subBuilder: $20.OutputAudioConfig.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(3)
  set webhookStatus($21.Status v) { setField(3, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(6)
  set outputAudioConfig($20.OutputAudioConfig v) { setField(6, v); }
  @$pb.TagNumber(6)
...
class QueryParameters extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('QueryParameters', package: const $pb.PackageName('google.cloud.dialogflow.v2beta1'), createEmptyInstance: create)
    ..aOS(1, 'timeZone')
    ..aOM<$22.LatLng>(2, 'geoLocation', subBuilder: $22.LatLng.create)
    ..pc<$5.Context>(3, 'contexts', $pb.PbFieldType.PM, subBuilder: $5.Context.create)
    ..aOB(4, 'resetContexts')
    ..pc<$8.SessionEntityType>(5, 'sessionEntityTypes', $pb.PbFieldType.PM, subBuilder: $8.SessionEntityType.create)
    ..aOM<$19.Struct>(6, 'payload', subBuilder: $19.Struct.create)
    ...
    ..pc<$3.SubAgent>(13, 'subAgents', $pb.PbFieldType.PM, subBuilder: $3.SubAgent.create)
    ..m<$core.String, $core.String>(14, 'webhookHeaders', entryClassName: 'QueryParameters.WebhookHeadersEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.cloud.dialogflow.v2beta1'))
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  set geoLocation($22.LatLng v) { setField(2, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(6)
  set payload($19.Struct v) { setField(6, v); }
  @$pb.TagNumber(6)
...
class QueryInput extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('QueryInput', package: const $pb.PackageName('google.cloud.dialogflow.v2beta1'), createEmptyInstance: create)
    ..oo(0, [1, 2, 3])
    ..aOM<$20.InputAudioConfig>(1, 'audioConfig', subBuilder: $20.InputAudioConfig.create)
  ...
  @$pb.TagNumber(1)
  set audioConfig($20.InputAudioConfig v) { setField(1, v); }
  @$pb.TagNumber(1)
...
class QueryResult extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('QueryResult', package: const $pb.PackageName('google.cloud.dialogflow.v2beta1'), createEmptyInstance: create)
    ..aOS(1, 'queryText')
    ..a<$core.double>(2, 'speechRecognitionConfidence', $pb.PbFieldType.OF)
    ..aOS(3, 'action')
    ..aOM<$19.Struct>(4, 'parameters', subBuilder: $19.Struct.create)
    ..aOB(5, 'allRequiredParamsPresent')
    ..aOS(6, 'fulfillmentText')
    ..pc<$6.Intent_Message>(7, 'fulfillmentMessages', $pb.PbFieldType.PM, subBuilder: $6.Intent_Message.create)
    ..aOS(8, 'webhookSource')
    ..aOM<$19.Struct>(9, 'webhookPayload', subBuilder: $19.Struct.create)
    ..pc<$5.Context>(10, 'outputContexts', $pb.PbFieldType.PM, subBuilder: $5.Context.create)
    ..aOM<$6.Intent>(11, 'intent', subBuilder: $6.Intent.create)
    ..a<$core.double>(12, 'intentDetectionConfidence', $pb.PbFieldType.OF)
    ..aOM<$19.Struct>(14, 'diagnosticInfo', subBuilder: $19.Struct.create)
    ..aOS(15, 'languageCode')
    ..aOM<SentimentAnalysisResult>(17, 'sentimentAnalysisResult', subBuilder: SentimentAnalysisResult.create)
    ..aOM<KnowledgeAnswers>(18, 'knowledgeAnswers', subBuilder: KnowledgeAnswers.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(4)
  set parameters($19.Struct v) { setField(4, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(9)
  set webhookPayload($19.Struct v) { setField(9, v); }
  @$pb.TagNumber(9)
  ...
  @$pb.TagNumber(11)
  set intent($6.Intent v) { setField(11, v); }
  @$pb.TagNumber(11)
  ...
  @$pb.TagNumber(14)
  set diagnosticInfo($19.Struct v) { setField(14, v); }
  @$pb.TagNumber(14)
...
class KnowledgeAnswers_Answer extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('KnowledgeAnswers.Answer', package: const $pb.PackageName('google.cloud.dialogflow.v2beta1'), createEmptyInstance: create)
    ..aOS(1, 'source')
    ..aOS(2, 'faqQuestion')
    ..aOS(3, 'answer')
  ...
  KnowledgeAnswers_Answer copyWith(void Function(KnowledgeAnswers_Answer) updates) => super.copyWith((message) => updates(message as KnowledgeAnswers_Answer));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class KnowledgeAnswers extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('KnowledgeAnswers', package: const $pb.PackageName('google.cloud.dialogflow.v2beta1'), createEmptyInstance: create)
    ..pc<KnowledgeAnswers_Answer>(1, 'answers', $pb.PbFieldType.PM, subBuilder: KnowledgeAnswers_Answer.create)
    ..hasRequiredFields = false
  ;
  ...
  KnowledgeAnswers copyWith(void Function(KnowledgeAnswers) updates) => super.copyWith((message) => updates(message as KnowledgeAnswers));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class StreamingDetectIntentRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('StreamingDetectIntentRequest', package: const $pb.PackageName('google.cloud.dialogflow.v2beta1'), createEmptyInstance: create)
    ..aOS(1, 'session')
    ..aOM<QueryParameters>(2, 'queryParams', subBuilder: QueryParameters.create)
    ..aOM<QueryInput>(3, 'queryInput', subBuilder: QueryInput.create)
    ..aOB(4, 'singleUtterance')
    ..aOM<$20.OutputAudioConfig>(5, 'outputAudioConfig', subBuilder: $20.OutputAudioConfig.create)
  ...
  @$pb.TagNumber(5)
  set outputAudioConfig($20.OutputAudioConfig v) { setField(5, v); }
  @$pb.TagNumber(5)
...
class StreamingDetectIntentResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('StreamingDetectIntentResponse', package: const $pb.PackageName('google.cloud.dialogflow.v2beta1'), createEmptyInstance: create)
    ..aOS(1, 'responseId')
    ...
    ..aOM<$21.Status>(4, 'webhookStatus', subBuilder: $21.Status.create)
    ..a<$core.List<$core.int>>(5, 'outputAudio', $pb.PbFieldType.OY)
    ..aOM<$20.OutputAudioConfig>(6, 'outputAudioConfig', subBuilder: $20.OutputAudioConfig.create)
    ..pc<QueryResult>(7, 'alternativeQueryResults', $pb.PbFieldType.PM, subBuilder: QueryResult.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(4)
  set webhookStatus($21.Status v) { setField(4, v); }
  @$pb.TagNumber(4)
...
class StreamingRecognitionResult extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('StreamingRecognitionResult', package: const $pb.PackageName('google.cloud.dialogflow.v2beta1'), createEmptyInstance: create)
    ...
    ..aOM<$20.TelephonyDtmfEvents>(5, 'dtmfDigits', subBuilder: $20.TelephonyDtmfEvents.create)
    ..a<$core.double>(6, 'stability', $pb.PbFieldType.OF)
    ..pc<$20.SpeechWordInfo>(7, 'speechWordInfo', $pb.PbFieldType.PM, subBuilder: $20.SpeechWordInfo.create)
    ..aOM<$16.Duration>(8, 'speechEndOffset', subBuilder: $16.Duration.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(5)
  set dtmfDigits($20.TelephonyDtmfEvents v) { setField(5, v); }
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(8)
  set speechEndOffset($16.Duration v) { setField(8, v); }
  @$pb.TagNumber(8)
...
class TextInput extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('TextInput', package: const $pb.PackageName('google.cloud.dialogflow.v2beta1'), createEmptyInstance: create)
    ..aOS(1, 'text')
    ..aOS(2, 'languageCode')
    ..hasRequiredFields = false
  ;
...
class EventInput extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('EventInput', package: const $pb.PackageName('google.cloud.dialogflow.v2beta1'), createEmptyInstance: create)
    ..aOS(1, 'name')
    ..aOM<$19.Struct>(2, 'parameters', subBuilder: $19.Struct.create)
    ..aOS(3, 'languageCode')
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  set parameters($19.Struct v) { setField(2, v); }
  @$pb.TagNumber(2)
...
class SentimentAnalysisRequestConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('SentimentAnalysisRequestConfig', package: const $pb.PackageName('google.cloud.dialogflow.v2beta1'), createEmptyInstance: create)
...
class SentimentAnalysisResult extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('SentimentAnalysisResult', package: const $pb.PackageName('google.cloud.dialogflow.v2beta1'), createEmptyInstance: create)
...
class Sentiment extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Sentiment', package: const $pb.PackageName('google.cloud.dialogflow.v2beta1'), createEmptyInstance: create)
