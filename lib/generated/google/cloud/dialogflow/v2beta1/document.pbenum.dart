...
class Document_KnowledgeType extends $pb.ProtobufEnum {
  static const Document_KnowledgeType KNOWLEDGE_TYPE_UNSPECIFIED = Document_KnowledgeType._(0, 'KNOWLEDGE_TYPE_UNSPECIFIED');
  static const Document_KnowledgeType FAQ = Document_KnowledgeType._(1, 'FAQ');
  static const Document_KnowledgeType EXTRACTIVE_QA = Document_KnowledgeType._(2, 'EXTRACTIVE_QA');
  static const Document_KnowledgeType ARTICLE_SUGGESTION = Document_KnowledgeType._(3, 'ARTICLE_SUGGESTION');
  static const Document_KnowledgeType SMART_REPLY = Document_KnowledgeType._(4, 'SMART_REPLY');
...
class KnowledgeOperationMetadata_State extends $pb.ProtobufEnum {
  static const KnowledgeOperationMetadata_State STATE_UNSPECIFIED = KnowledgeOperationMetadata_State._(0, 'STATE_UNSPECIFIED');
  static const KnowledgeOperationMetadata_State PENDING = KnowledgeOperationMetadata_State._(1, 'PENDING');
  static const KnowledgeOperationMetadata_State RUNNING = KnowledgeOperationMetadata_State._(2, 'RUNNING');
  static const KnowledgeOperationMetadata_State DONE = KnowledgeOperationMetadata_State._(3, 'DONE');
