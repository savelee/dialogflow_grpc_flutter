...
class KnowledgeAnswers_Answer_MatchConfidenceLevel extends $pb.ProtobufEnum {
  static const KnowledgeAnswers_Answer_MatchConfidenceLevel MATCH_CONFIDENCE_LEVEL_UNSPECIFIED = KnowledgeAnswers_Answer_MatchConfidenceLevel._(0, 'MATCH_CONFIDENCE_LEVEL_UNSPECIFIED');
  static const KnowledgeAnswers_Answer_MatchConfidenceLevel LOW = KnowledgeAnswers_Answer_MatchConfidenceLevel._(1, 'LOW');
  static const KnowledgeAnswers_Answer_MatchConfidenceLevel MEDIUM = KnowledgeAnswers_Answer_MatchConfidenceLevel._(2, 'MEDIUM');
  static const KnowledgeAnswers_Answer_MatchConfidenceLevel HIGH = KnowledgeAnswers_Answer_MatchConfidenceLevel._(3, 'HIGH');
