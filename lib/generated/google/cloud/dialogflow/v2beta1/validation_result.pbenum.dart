...
class ValidationError_Severity extends $pb.ProtobufEnum {
  static const ValidationError_Severity SEVERITY_UNSPECIFIED = ValidationError_Severity._(0, 'SEVERITY_UNSPECIFIED');
  static const ValidationError_Severity INFO = ValidationError_Severity._(1, 'INFO');
  static const ValidationError_Severity WARNING = ValidationError_Severity._(2, 'WARNING');
  static const ValidationError_Severity ERROR = ValidationError_Severity._(3, 'ERROR');
  static const ValidationError_Severity CRITICAL = ValidationError_Severity._(4, 'CRITICAL');
