...
class HumanAgentAssistantEvent extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('HumanAgentAssistantEvent', package: const $pb.PackageName('google.cloud.dialogflow.v2beta1'), createEmptyInstance: create)
    ..aOS(1, 'conversation')
    ..aOS(3, 'participant')
    ..pc<$10.SuggestionResult>(5, 'suggestionResults', $pb.PbFieldType.PM, subBuilder: $10.SuggestionResult.create)
  ...
  @$pb.TagNumber(5)
  $core.List<$10.SuggestionResult> get suggestionResults => $_getList(2);
}
