...
class SuggestionFeature_Type extends $pb.ProtobufEnum {
  static const SuggestionFeature_Type TYPE_UNSPECIFIED = SuggestionFeature_Type._(0, 'TYPE_UNSPECIFIED');
  static const SuggestionFeature_Type ARTICLE_SUGGESTION = SuggestionFeature_Type._(1, 'ARTICLE_SUGGESTION');
  static const SuggestionFeature_Type FAQ = SuggestionFeature_Type._(2, 'FAQ');
  static const SuggestionFeature_Type SMART_REPLY = SuggestionFeature_Type._(3, 'SMART_REPLY');
