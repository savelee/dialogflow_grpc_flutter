...
class ValidationError extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ValidationError', package: const $pb.PackageName('google.cloud.dialogflow.v2beta1'), createEmptyInstance: create)
    ..e<ValidationError_Severity>(1, 'severity', $pb.PbFieldType.OE, defaultOrMaker: ValidationError_Severity.SEVERITY_UNSPECIFIED, valueOf: ValidationError_Severity.valueOf, enumValues: ValidationError_Severity.values)
    ..pPS(3, 'entries')
    ..aOS(4, 'errorMessage')
...
class ValidationResult extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ValidationResult', package: const $pb.PackageName('google.cloud.dialogflow.v2beta1'), createEmptyInstance: create)
    ..pc<ValidationError>(1, 'validationErrors', $pb.PbFieldType.PM, subBuilder: ValidationError.create)
    ..hasRequiredFields = false
  ;
  ...
  ValidationResult copyWith(void Function(ValidationResult) updates) => super.copyWith((message) => updates(message as ValidationResult));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
