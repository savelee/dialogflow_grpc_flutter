...
class RetryInfo extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('RetryInfo', package: const $pb.PackageName('google.rpc'), createEmptyInstance: create)
...
class DebugInfo extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('DebugInfo', package: const $pb.PackageName('google.rpc'), createEmptyInstance: create)
    ..pPS(1, 'stackEntries')
    ..aOS(2, 'detail')
    ..hasRequiredFields = false
  ;
...
class QuotaFailure_Violation extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('QuotaFailure.Violation', package: const $pb.PackageName('google.rpc'), createEmptyInstance: create)
    ..aOS(1, 'subject')
    ..aOS(2, 'description')
    ..hasRequiredFields = false
  ;
...
class QuotaFailure extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('QuotaFailure', package: const $pb.PackageName('google.rpc'), createEmptyInstance: create)
    ..pc<QuotaFailure_Violation>(1, 'violations', $pb.PbFieldType.PM, subBuilder: QuotaFailure_Violation.create)
    ..hasRequiredFields = false
  ;
...
class ErrorInfo extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ErrorInfo', package: const $pb.PackageName('google.rpc'), createEmptyInstance: create)
    ..aOS(1, 'reason')
    ..aOS(2, 'domain')
    ..m<$core.String, $core.String>(3, 'metadata', entryClassName: 'ErrorInfo.MetadataEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.rpc'))
    ..hasRequiredFields = false
  ;
...
class PreconditionFailure_Violation extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('PreconditionFailure.Violation', package: const $pb.PackageName('google.rpc'), createEmptyInstance: create)
    ..aOS(1, 'type')
    ..aOS(2, 'subject')
    ..aOS(3, 'description')
    ..hasRequiredFields = false
...
class PreconditionFailure extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('PreconditionFailure', package: const $pb.PackageName('google.rpc'), createEmptyInstance: create)
    ..pc<PreconditionFailure_Violation>(1, 'violations', $pb.PbFieldType.PM, subBuilder: PreconditionFailure_Violation.create)
    ..hasRequiredFields = false
  ;
...
class BadRequest_FieldViolation extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('BadRequest.FieldViolation', package: const $pb.PackageName('google.rpc'), createEmptyInstance: create)
    ..aOS(1, 'field')
    ..aOS(2, 'description')
    ..hasRequiredFields = false
  ;
...
class BadRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('BadRequest', package: const $pb.PackageName('google.rpc'), createEmptyInstance: create)
    ..pc<BadRequest_FieldViolation>(1, 'fieldViolations', $pb.PbFieldType.PM, subBuilder: BadRequest_FieldViolation.create)
    ..hasRequiredFields = false
  ;
...
class RequestInfo extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('RequestInfo', package: const $pb.PackageName('google.rpc'), createEmptyInstance: create)
    ..aOS(1, 'requestId')
    ..aOS(2, 'servingData')
    ..hasRequiredFields = false
  ;
...
class ResourceInfo extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ResourceInfo', package: const $pb.PackageName('google.rpc'), createEmptyInstance: create)
    ..aOS(1, 'resourceType')
    ..aOS(2, 'resourceName')
    ..aOS(3, 'owner')
    ..aOS(4, 'description')
...
class Help_Link extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Help.Link', package: const $pb.PackageName('google.rpc'), createEmptyInstance: create)
    ..aOS(1, 'description')
    ..aOS(2, 'url')
    ..hasRequiredFields = false
  ;
...
class Help extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Help', package: const $pb.PackageName('google.rpc'), createEmptyInstance: create)
    ..pc<Help_Link>(1, 'links', $pb.PbFieldType.PM, subBuilder: Help_Link.create)
    ..hasRequiredFields = false
  ;
...
class LocalizedMessage extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('LocalizedMessage', package: const $pb.PackageName('google.rpc'), createEmptyInstance: create)
    ..aOS(1, 'locale')
    ..aOS(2, 'message')
    ..hasRequiredFields = false
  ;
